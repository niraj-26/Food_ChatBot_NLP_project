...
# Detect demo / cloud mode
DEMO_MODE = os.getenv("RENDER") == "true"
...
if not DEMO_MODE:
    try:
        ...
        print("Database connected (Local mode)")
    except Exception as e:
        print("Database connection failed, switching to demo mode:", e)
        cnx = None
else:
    print("Running in DEMO MODE (Cloud deployment)")
